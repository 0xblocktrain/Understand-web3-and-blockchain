...
-   [Wtf is web3](https://cobie.substack.com/p/wtf-is-web3?utm_source=substack&utm_campaign=post_embed&utm_medium=web&s=r)
...
## ![](https://lh5.googleusercontent.com/Pcq1n10ts-X9DSqXsHu4AuUUmXa6VO8ghEJHxcEOghxPsfeLfNWfRb4p5zj59HGV1JdmrSUDqfJyPAR1cyl0BYiVvsQfVwfojSjXqS7FjhOcQE9zIZifaCdS9NypwcEesjleP5yuk9RuXTpbJw)
...
-   [Types of blockchain](https://www.gemini.com/cryptopedia/blockchain-types-pow-pos-private)
...
Watch the complete blockchain developer roadmap here: [https://youtu.be/CJhUed6msJA](https://youtu.be/CJhUed6msJA)

  

Decentralized applications (dApps) are digital applications or programs that exist and run on a [blockchain](https://www.investopedia.com/terms/b/blockchain.asp) or [peer-to-peer](https://www.investopedia.com/terms/p/peertopeer-p2p-service.asp) (P2P) network of computers instead of a single computer. DApps (also called "dapps") are outside the purview and control of a single authority. DApps—which are often built on the [Ethereum](https://www.investopedia.com/terms/e/ethereum.asp) platform—can be developed for a variety of purposes including gaming, finance, and social media.
...
In the context of cryptocurrencies, dApps run on a blockchain network in a public, [open-source](https://www.investopedia.com/terms/o/open-source.asp), decentralized environment and are free from control and interference by any single authority. For example, a developer can create a Twitter-like dApp and put it on a blockchain where any user can publish messages. Once posted, no one—including the app creators—can delete the messages.
...
-   [Technical guide on btc and eth](https://newsletter.banklesshq.com/p/-guide-1-starting-with-bankless?s=r)
...
## ![](https://lh4.googleusercontent.com/g-v1IoYaf_uuKT284GuXUUjtzLtLrfvPryETndo53Lx05rVCU51W27XTXEQw0RyS3dNFDqA3pn28mul5R6glE4zvZCLsiBnrWPppa5CGNbA0-qTH6MJfwYsJrWKqFnRP4Y9hR1sjuyC9dxXtzg)
...
-   [https://medium.com/the-capital/layer-1-vs-layer-2-what-you-need-to-know-about-different-blockchain-layer-solutions-69f91904ce40](https://medium.com/the-capital/layer-1-vs-layer-2-what-you-need-to-know-about-different-blockchain-layer-solutions-69f91904ce40)
    
-   [https://academy.binance.com/en/articles/blockchain-layer-1-vs-layer-2-scaling-solutions](https://academy.binance.com/en/articles/blockchain-layer-1-vs-layer-2-scaling-solutions)
...
![](https://lh4.googleusercontent.com/fTkkkjafauGRsHQ8tWm5ekxHq87bxdZH142i_b9U1VUvwWMBvGrTlupfVlItz_lCIm_CP4isIYZG0TbbRO32f5YTa7frRcbY1OXgu-sRnqOE_-WIhOfHxN8NF-y0v_3DwZ6c5JEq7v1qgBbA4A)
...
-   The Ethereum Virtual Machine is the software platform that developers can use to create [decentralized applications (DApps)](https://www.sofi.com/learn/content/what-is-a-dapp/) on Ethereum. This virtual machine is where all Ethereum accounts and smart contracts live.
...
-   EVM works like a large [decentralized](https://coinmarketcap.com/alexandria/glossary/decentralized) or master computer to complete all types of tasks on the blockchain.
...
-   Every project is working towards making transactions faster, adding multi-chain functionality, and more. Polkadot has added Moonbeam, Near launches Aurora, and soon (announced but not released), Evmos will be live on Cosmos and Neon will be implemented on Solana, eg: [https://aurora.dev/](https://aurora.dev/)
    
-   Solana is an example of a non-EVM project.
    
-   Cardano is now EVM compatible!?
    
-   [https://coinwut.com/cardano-evm-compatible/](https://coinwut.com/cardano-evm-compatible/)
    
-   [https://medium.com/coinmonks/cardano-determinism-e-utxo-ledger-model-ef183d1e88ce](https://medium.com/coinmonks/cardano-determinism-e-utxo-ledger-model-ef183d1e88ce)
...
![](https://lh3.googleusercontent.com/w0s5GhO1jWxoBwLynW-nYV5w9y-97ID_iXG9woh-7MCcg7rPXWz2o43fTncksiyL742tfe07C35VJ5XtSyDR_6JLLzgxuSZdoAFpfQirIo5jRdEXUpqtTLY4aVl07q11CZFtf1NIb4zQTFP6NA)
...
Proof-of-History is a high [Verifiable Delay Function](https://www.youtube.com/watch?v=_-feyaZZjEw) (VDF). Solana requires validators to solve these VDFs continuously. A VDF requires a specific number of sequence steps to evaluate but also produces a unique output that can be efficiently and publicly verified. VDFs can only be solved by a single CPU core applying a particular set of sequential steps.

  
  

Solana runs a [Tower Byzantine Fault Tolerance](https://medium.com/solana-labs/tower-bft-solanas-high-performance-implementation-of-pbft-464725911e79) (BFT) consensus mechanism on their Proof-of-History protocol.
...
![](https://lh3.googleusercontent.com/BFiiRc1si-P2OUK2cqGY3muHhZVIX1vby2DqQEe_A-imb1UF3UpVGlei85gS1AwBhkjbByuGcyglz3TxsF8RhgpOPC5vb0elFYaHFur2i6w5LDtnyeeN5HoPluefhoCeg7VaZ7uI7qjutuUg)

  

-   ERC is essentially the acronym for Ethereum Request for Comments. ERCs are Ethereum application-level specifications, such as token standards, name registries, library/package formats, and more. Anyone may make an ERC token with [Ethereum Blockchain app development](https://blockchain.oodles.io/ethereum-application-development-services/), but the author must explicitly clarify their standard and gain community approval for it.
...
-   [https://blockchain.oodles.io/blog/quick-guide-ethereum-erc-token-standards/](https://blockchain.oodles.io/blog/quick-guide-ethereum-erc-token-standards/)
...
## DAOs![](https://lh6.googleusercontent.com/AobnMG06xRIYYerYjR-MRHI4sDyL5g_x1AHJ5BGgrxrbr7XxrErIERAq9crjq5Fv0DKZ_pDJ5CoVm4YRlvZWUU2DLFw7LGEMV1NI3gSJlrvaE4UxRYyYMhQkCNKauuHcR8ia625dhF9wKlRn)
...
## IPFS![](https://lh3.googleusercontent.com/HGlQGeZKzoYUywlx-F-TohjUKff7GJvKZGeOehdBaDOCP7L_hZA-4B_15bNRxS_pI057jhFeV6j8wB78CdP2xuPIM5jD-hxSYq_CRzqehCCt2EZRk3xsfQNsRYOS4WI2sYbrZN4SCiT46Tsaxg)
...
-   [https://blog.infura.io/post/an-introduction-to-ipfs](https://blog.infura.io/post/an-introduction-to-ipfs)
    
-   [https://docs.ipfs.io/concepts/how-ipfs-works/](https://docs.ipfs.io/concepts/how-ipfs-works/)
